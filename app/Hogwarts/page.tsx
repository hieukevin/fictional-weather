...
const Page = () => {
  return (
    <div
      className={`min-h-screen min-w-full grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-10 z-10 p-5`}
    >
      ...
      <div
        className={`md:col-start-1 md:row-start-1 md:col-span-1 md:row-span-4 hidden md:block`}
      >
        <Sidebar />
      </div>
